  ...
  <div class="">
    <div class="relative">
      ...
      <input
        ...
        class="block w-full px-9 py-2.5 bg-bgray-50 border-1 rounded-lg font-sans text-bgray-950 focus:text-blue-700 text-sm appearance-none focus:outline-none focus:ring-1 focus:ring-blue-500/50 focus:border-blue-500 transition-colors duration-200 placeholder-transparent border-bgray-950 peer disabled:pointer-events-none"
        @focus="focused = true"
        @blur="focused = false"
